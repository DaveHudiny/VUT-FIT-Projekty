...
protected:
     ...
     * Struktura korene fronty s ukazatelem na prvni prvek.
     */
    struct Root
    {
        Element_t *first;
    ...
    /**
    * @brief Koren fronty
    * Ukazatel na koren fronty.
    */
    Root *root;

    /**
    * @brief NewFirstElement
    * Vytvari novy prvni prvek v prioritni fronte se zvolenou hodnotou.
    */

    PriorityQueue::Element_t *NewElement(int value);
};
#endif // TDD_CODE_H_
