...
char result[10] = "xxxx";
void printDouble(double v, int decimalDigits) // https://stackoverflow.com/questions/12703307/arm-none-eabi-gcc-printing-float-number-using-printf
{
  int i = 1;
  ...
  sprintf(result,"%i.%i", intPart, fractPart);
}
